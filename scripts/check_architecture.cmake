...
foreach(component_path IN LISTS component_paths)
    if(IS_DIRECTORY "${component_path}")
        ...
        # 仅有组件构建声明的目录才属于当前架构组件。已删除组件遗留的空目录
        # 不能让验证图继续要求其依赖和源码。
        if(EXISTS "${component_path}/CMakeLists.txt")
...
assert_dependencies(voicelife_mcp PUBLIC voicelife_contracts voicelife_schedule)
assert_dependencies(voicelife_mcp PRIVATE freertos yyjson)
...
assert_dependencies(voicelife_runtime PRIVATE esp-tls esp_app_format esp_driver_gpio esp_driver_usb_serial_jtag led_strip esp_event esp_http_client esp_netif lwip esp_partition esp_psram esp_timer esp_wifi nvs_flash nvs_sec_provider spi_flash voicelife_im voicelife_linx voicelife_linx_esp voicelife_mcp voicelife_voice voicelife_audio_esp voicelife_display_esp voicelife_storage_fatfs voicelife_storage_sqlite)
