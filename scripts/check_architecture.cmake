...
function(load_dependencies component_name)
    file(READ "${VOICELIFE_ROOT}/components/${component_name}/CMakeLists.txt" component_cmake)
    if(component_cmake MATCHES "\.\./voicelife_[a-z0-9_]+/include")
        message(FATAL_ERROR
            "${component_name} must declare a component dependency instead of importing another component's include path")
    endif()
...
assert_dependencies(voicelife_application PUBLIC voicelife_contracts voicelife_voice)
