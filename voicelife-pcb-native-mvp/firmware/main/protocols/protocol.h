...
public:
    ...
    virtual void SendStopListening(ListeningMode mode);
    virtual void SendAbortSpeaking(AbortReason reason);
    virtual bool SendMcpMessage(const std::string& message);
    // Inject a text turn into the active Linx session (used for local reminder
    // announcements). Returns false when the transport is not ready.
