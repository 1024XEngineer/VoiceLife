...
| 读者 | 入口 |
| --- | --- |
| 使用者与新贡献者 | [项目 README](../README.md)、[协同开发](engineering/collaboration.md)、[安全报告](engineering/security-reporting.md) |
...
| 协作与交付 | [协同开发](engineering/collaboration.md)、[质量门禁](engineering/ci-quality-gates.md)、[契约版本](engineering/contract-versioning.md)、[提交规范](engineering/commit-convention.md)、[第三方来源与许可](engineering/third-party-notices.md) |
