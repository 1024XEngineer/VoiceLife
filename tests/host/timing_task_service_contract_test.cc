...
concept TimingTaskServiceContract =
    requires(Service& service, const RegisterTimerTaskCommand& register_command,
             const UpdateTimerTaskCommand& update_command, const CancelTimerTaskCommand& cancel_command,
             const UpsertReminderRulesCommand& upsert_rules_command,
