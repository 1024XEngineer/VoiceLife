...
(schedule_id, chain_id, attempt, timing_task_id, trigger_at, business_status, timer_status,
 triggered_at, action_operation_id, action_kind, action_occurred_at, action_next_trigger_at, action_reported,
...
UPDATE schedule_reminder_task SET schedule_id = ?, chain_id = ?, attempt = ?, timing_task_id = ?, trigger_at = ?,
 ...
 action_occurred_at = ?, action_next_trigger_at = ?, action_reported = ?, created_at = ?, updated_at = ? WHERE id = ?
)sql";
}  // namespace voicelife::storage_sqlite::sql
